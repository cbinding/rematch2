...
def create_periodo_ruler(
    ...
    periods: list[dict] = pd.get_period_list(periodo_authority_id)
...
# python -m components.PeriodoRuler
if __name__ == "__main__":
    ...
    # tests = json.load(f)
    nlp = load_pipeline_for_language("fr")
    ...
    #print([f"\"{span.text}\"\t{span.label_}\n" for span in doc.spans[DEFAULT_SPANS_KEY]])
