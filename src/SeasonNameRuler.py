...
Summary :   spaCy custom pipeline component (specialized EntityRuler)
            Language-sensitive component to identify and tag season names
...
if __name__ == "__main__":    
    ...
    tests = [
        { "language": "de", "pipe": "de_core_news_sm", "text": "Im Frühling oder im Sommer oder im Herbst oder im Winter" },
        { "language": "en", "pipe": "en_core_web_sm", "text": "In Spring, or in Summer, or in Autumn or in Winter" },
        { "language": "es", "pipe": "es_core_news_sm", "text": "En primavera, o en verano, o en otoño o en invierno" },
        { "language": "fr", "pipe": "fr_core_news_sm", "text": "Au printemps, ou en été, ou en automne ou en hiver" },
        { "language": "it", "pipe": "it_core_news_sm", "text": "In primavera, o in estate, o in autunno o in inverno" },
        { "language": "nl", "pipe": "nl_core_news_sm", "text": "In de lente, of in de zomer, of in de herfst of in de winter" },
        { "language": "no", "pipe": "nb_core_news_sm", "text": "Om våren, eller om sommeren, eller om høsten eller om vinteren" },
        { "language": "sv", "pipe": "sv_core_news_sm", "text": "På våren, eller på sommaren, eller på hösten eller på vintern" }
    ]
    for test in tests:
