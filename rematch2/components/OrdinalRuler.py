...
if __name__ == "__main__":
    ...
    tests = [
        { "lang": "de", "pipe": "de_core_news_sm", "text": "vom ersten, vierten und sechsten bis zum 19. oder 20. Jahrhundert" },
        { "lang": "en", "pipe": "en_core_web_sm", "text": "from the first, the fourth and the sixth to the 19th or 20th century" },
        { "lang": "es", "pipe": "es_core_news_sm", "text": "desde el primero, el cuarto y el sexto hasta el siglo XIX o XX" },
        { "lang": "fr", "pipe": "fr_core_news_sm", "text": "du premier, quatrième et sixième au XIXe ou XXe siècle" },
        { "lang": "it", "pipe": "it_core_news_sm", "text": "dal primo, quarto e sesto al XIX o XX secolo" },
        { "lang": "nl", "pipe": "nl_core_news_sm", "text": "van de eerste, de vierde en de zesde tot de 19e of 20e eeuw" },
        { "lang": "no", "pipe": "nb_core_news_sm", "text": "fra det første, det fjerde og det sjette til det 19. eller 20. århundre" },
        { "lang": "sv", "pipe": "sv_core_news_sm", "text": "från det första, det fjärde och det sjätte till 1800- eller 1900-talet" }
    ]
    for test in tests:
        print(f"-------------\nlanguage = {test['lang']}")
