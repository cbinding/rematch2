...
def main():
    ...
    txt2 = "the quickest brownest foxes jumped over the laziest dogs. The programming indicated that the early iron ages was archaeologically and educationally significant"
